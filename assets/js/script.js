...
var taskFormHandler = function(event) {
    ...
    // no data attribute, so creat object as notmal and pass to createTaskEl function
    else {
...
var deleteTask = function(taskId) {
    ...
    for (var i = 0; i < tasks.length; i++) {
        // if tasks[i].id doesnt math the value of taskID, let's keep that task and push it into the new array
        if (tasks[i].id !== parseInt(taskId)) {
...
// converts tasks from the string to format back in to an array of objects
